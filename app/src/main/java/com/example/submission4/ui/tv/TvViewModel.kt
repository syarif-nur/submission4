...
class TvViewModel: ViewModel() {
    ...
    internal fun setTvShow(locale: String){
        val client = AsyncHttpClient()
        val listItems = ArrayList<FilmModel>()
        val url = "https://api.themoviedb.org/3/discover/tv?api_key=$API_KEY&language=$locale"
            ...
            override fun onSuccess(
                ...
                try {
                    ...
                    for (i in 0 until list.length()) {
                        ...
                        movieItems.title = movie.getString("original_name")
    ...
    internal fun getTv(): LiveData<ArrayList<FilmModel>> {
        return listFilms
    }
